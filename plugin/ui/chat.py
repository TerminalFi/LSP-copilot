...
class ViewConversationManager:
    ...
    def group_id(self) -> int:
        ...
        return get_copilot_view_setting(self.view, "conversation_group_id", -1)

    @group_id.setter
    def group_id(self, value: int) -> None:
        set_copilot_view_setting(self.view, "conversation_group_id", value)

    @property
    def sheet_id(self) -> int:
        """The ID of the sheet which is used to show panel completions."""
        return get_copilot_view_setting(self.view, "conversation_sheet_id", -1)

    @sheet_id.setter
    def sheet_id(self, value: int) -> None:
        set_copilot_view_setting(self.view, "conversation_sheet_id", value)
    ...
    @classmethod
    def from_sheet_id(cls, sheet_id: int) -> ViewConversationManager | None:
...
class _ConversationEntry:
    CSS_CLASS_NAME = "copilot-conversration-entry"
    CSS = f"""
        html {{
    ...
    def __init__(self, view: sublime.View) -> None:
        self.view = view
        self.completion_manager = ViewConversationManager(view)
